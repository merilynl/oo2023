 ...
 */
 ...
 class KeskmiseArvutus{
	protected m1:number[]=[];
	protected keskmised:number[]=[];
	lisa(x:number){
		this.m1.push(x);
		if(this.m1.length>=3){
			this.keskmised.push((this.m1[this.m1.length-1]+this.m1[this.m1.length-2]+this.m1[this.m1.length-3])/3);
		}
	}
 ...
 let k1:KeskmiseArvutus=new KeskmiseArvutus();
 k1.lisa(2);k1.lisa(16);k1.lisa(8);k1.lisa(1);k1.lisa(23);k1.lisa(2);
 console.log(k1.libisevKeskmine());